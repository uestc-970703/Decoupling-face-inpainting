...
class Demo():
    ...
    def save_results(self, save_dir, supervision_only=False):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Facial structure estimator configurations.')
    ...
    parser.add_argument('--detect_human_face', default=False, action='store_true', help='Enable automatic human face detection.')
    parser.add_argument('--render_video', default=False, action='store_true', help='Render 3D animations to video')
    parser.add_argument('--supervision_only', default=False, action='store_true', help='Save only canonical_image_lap, canonical_normal_lap, and recon_normal_lap for inpainting training supervision')
    ...
    for im_path in im_list:
        ...
        model.save_results(save_dir, supervision_only=args.supervision_only)
