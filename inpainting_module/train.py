...
def setup_training_loop_kwargs(
    ...
    structure_image_weight = None,
    structure_normal_weight = None,
    structure_canonical_normal_weight = None,
    structure_recon_normal_weight = None,
    structure_normal_cosine_weight = None,
    structure_output_size = None,
    ...
    if structure_checkpoint is not None:
        assert isinstance(structure_checkpoint, str)
        desc += '-structure'
        args.loss_kwargs.structure_checkpoint = structure_checkpoint

    if structure_image_weight is not None:
        assert isinstance(structure_image_weight, float)
        desc += f'-siw{structure_image_weight:g}'
        args.loss_kwargs.structure_image_weight = structure_image_weight

    if structure_normal_weight is not None:
        assert isinstance(structure_normal_weight, float)
        desc += f'-snw{structure_normal_weight:g}'
        args.loss_kwargs.structure_normal_weight = structure_normal_weight

    if structure_canonical_normal_weight is not None:
        assert isinstance(structure_canonical_normal_weight, float)
        desc += f'-scnw{structure_canonical_normal_weight:g}'
        args.loss_kwargs.structure_canonical_normal_weight = structure_canonical_normal_weight

    if structure_recon_normal_weight is not None:
        assert isinstance(structure_recon_normal_weight, float)
        desc += f'-srnw{structure_recon_normal_weight:g}'
        args.loss_kwargs.structure_recon_normal_weight = structure_recon_normal_weight

    if structure_normal_cosine_weight is not None:
        assert isinstance(structure_normal_cosine_weight, float)
        desc += f'-sncw{structure_normal_cosine_weight:g}'
        args.loss_kwargs.structure_normal_cosine_weight = structure_normal_cosine_weight

    if structure_output_size is not None:
        assert isinstance(structure_output_size, int)
        desc += f'-sos{structure_output_size:d}'
        args.loss_kwargs.structure_output_size = structure_output_size
...
@click.option('--structure_checkpoint', help='Path to the frozen facial structure estimator checkpoint', type=str, metavar='PATH')
@click.option('--structure_image_weight', help='Weight for CNN canonical_image_lap supervision', type=float)
@click.option('--structure_normal_weight', help='Weight for Transformer canonical/recon normal supervision', type=float)
@click.option('--structure_canonical_normal_weight', help='Relative weight for Transformer canonical_normal_lap supervision', type=float)
@click.option('--structure_recon_normal_weight', help='Relative weight for Transformer recon_normal_lap supervision', type=float)
@click.option('--structure_normal_cosine_weight', help='Optional cosine penalty weight for normal-map supervision', type=float)
@click.option('--structure_output_size', help='Output size for structure supervision maps [default: 128]', type=int)
